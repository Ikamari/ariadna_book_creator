...
var splitTextToPages = function splitTextToPages(text) {
    ...
    for (var i = 0; i < words.length; i++) {
        if (words[i][words[i].length - 1] === ':') {
            ...
            words[i + 1] ? words[i + 1] = words[i + 1].charAt(0).toUpperCase() + words[i + 1].slice(1) : undefined;
        }
...
var uploadFile = function uploadFile(data, name) {
    var a = document.getElementById('hidden-export'),
